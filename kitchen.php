<?php
    ...
    if(isset($_GET['complete'])){
        ...
        $result = mysqli_query($connection, $sql);
        if ($result) {
          header("Location: kitchen.php"); // Redirect back to the original page
        } else {
...
<body>
    ...
    <div class="home">
        <a href="home.php" type="button" class="btn btn-light btn-md">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#FFFFFF" class="bi bi-house-fill"
                viewBox="0 0 16 16">
                <path
  ...
  ?>
        ...
        <button class="btn btn-light btn-sm shareButton" id="shareButton"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="container">
            <table class="table" id="myTable">
                ...
                <tbody>
                    <?php 
          $sql = "SELECT * FROM `customlist` WHERE `name`='kitchen' and `user`='$user' ORDER by `complete`";
          $result = mysqli_query($connection, $sql);
          $sno = 0;
