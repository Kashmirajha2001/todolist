  ...
  ?>
        ...
        <div class="container">
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            echo " <a class='delete btn btn-sm btn-dark' id=".$row['sno']."><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash3-fill' viewBox='0 0 16 16'>
